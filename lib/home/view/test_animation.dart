...
class _TestAnimationState extends State<TestAnimation>
  ...
  late final filterColor =
      ColorTween(begin: AppColors.primary, end: AppColors.secondaryColor)
          .animate(_menuAC);
          ...
          children: [
            ...
            AnimatedBuilder(
              ...
              builder: (context, child) {
                return Container(
                  width:
                      Tween(begin: 200.0, end: cons.maxWidth).evaluate(_menuAC),
                  height: Tween(begin: 200.0, end: cons.maxHeight)
                      .evaluate(_menuAC),
